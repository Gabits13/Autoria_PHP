...
<div class="container mt-5 pt-5">
    <h1 class="text-center mb-4 mt-4">Alteração de Autor</h1>
    <form name="cliente" method="post" action="alterar_autor2.php" onsubmit="return validateForm()">
        <fieldset class="border p-4 mt-2 mb-2">
