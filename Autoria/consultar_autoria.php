...
<div class="container mt-5 pt-5">
    <h1 class="text-center mb-4 mt-4">Consulta de Autorias</h1>
    <form name="cliente" method="post" action="" onsubmit="return validateForm()">
        <fieldset class="border p-4 mt-2">
            <legend class="w-auto"><b>Informe o nome da Editora desejada:</b></legend>
            <div class="mb-3">
    ...
    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
                             ...
                             if(isset($btnenviar)) {
                               ...
                               $autoria = new Autoria();
                               $autoria->setEditora($editora. '%'); // o % serve para busca aproximada, ou seja começa com uma determinada letra 
                               $autorias = $autoria->consultar();
                             
                                 foreach($autorias as $autoria) {
                                     echo "<tr>";
                                     echo "<td>" . $autoria[0] . "</td>";
                                     echo "<td>" . $autoria[1] . "</td>";
                                     echo "<td>" . $autoria[2] . "</td>";
                                     echo "<td>" . $autoria[3] . "</td>";
                                     echo "</tr>";
                                 }
                    ...
                    <div class="text-center"> <!-- Div para centralizar o botão -->
                        ...
                        <a href="listar_autoria.php" class="btn btn-secondary">Ir para a página listar</a>
                    </div>
                    </div>
            </div>
        </div>
