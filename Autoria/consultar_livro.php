...
<div class="container mt-5 pt-5">
    <h1 class="text-center mb-4 mt-4">Consulta de Livro</h1>
    <form name="cliente" method="post" action="" onsubmit="return validateForm()">
        <fieldset class="border p-4 mt-2">
            <legend class="w-auto"><b>Informe o Titulo do livro desejado:</b></legend>
            <div class="mb-3">
                <label for="txttitulo" class="form-label">Titulo</label>
                <input name="txttitulo" type="text" class="form-control" id="txttitulo" placeholder="Nome do Livro">
            </div>
        </fieldset>
        <br>
    ...
    <table class="table table-striped table-bordered">
                        ...
                        <?php
                          ...
                          if(isset($btnenviar)) {
                            ...
                            $livro = new Livro();
                            $livro->setTitulo($txttitulo. '%'); // o % serve para busca aproximada, ou seja começa com uma determinada letra 
                    ...
                    <div class="text-center">
                        ...
                        <a href="listar_livro.php" class="btn btn-secondary">Ir para a página listar</a>
                    </div>
                </div>
            </div>
        </div>
