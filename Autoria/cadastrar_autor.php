...
<div class="container mt-5 pt-5">
    <h1 class="text-center mb-4">Cadastro de Autor</h1>
    <form name="cliente" method="post" action="" onsubmit="return validateForm()">
        <fieldset class="border p-4 mt-2">
            <legend class="w-auto"><b>Dados do Autor:</b></legend>
            <div class="mb-3">
                <label for="txtnome" class="form-label">Nome do Autor</label>
                <input name="txtnome" type="text" class="form-control" id="txtnome" placeholder="Primeiro Nome">
            </div>
            <div class="mb-3">
                <label for="txtsobrenome" class="form-label">Sobrenome do Autor</label>
                <input name="txtsobrenome" type="text" class="form-control" id="txtsobrenome" placeholder="Sobrenome">
            </div>
            <div class="mb-3">
                <label for="txtemail" class="form-label">Email do Autor</label>
                <input name="txtemail" type="text" class="form-control" id="txtemail" placeholder="Ex: nome.doautor12@gmail.com">
            </div>
            <div class="mb-3">
                <label for="txtdate" class="form-label">Data de Nascimento</label>
                <input name="txtdate" type="date" class="form-control" id="txtdate" placeholder="Idioma">
            </div>
        </fieldset>
        <br>
