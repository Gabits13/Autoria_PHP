...
<div class="container mt-5 pt-5">
    <h1 class="text-center mb-4 mt-4">Exclusão de Autorias</h1>
    <form name="cliente" method="post" action="" onsubmit="return validateForm()">
        <fieldset class="border p-4 mt-2">
            ...
            <legend class="w-auto"><b>Informe o Codigo do Livro desejado:</b></legend>
            <div class="mb-3">
                <label for="txtcod2" class="form-label">Código do Livro:</label>
                <input name="txtcod2" type="text" class="form-control" id="txtnome" placeholder="Código do Livro">
            </div>
        </fieldset>
        <br>
