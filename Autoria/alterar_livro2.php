...
<div class="container mt-5 pt-5">
    <h1 class="text-center mb-4 mt-4">Alteração de Livros Cadastrados</h1>
        <fieldset class="border p-4 mt-2">
            <legend class="w-auto"><b>Alterar Livro</b></legend>

            <?php
                $txtcod= $_POST["txtcod"];
                include_once 'livro.php';
                $p = new Livro();
                $p->setCod_Livro($txtcod);
                $pro_bd=$p-> alterar();
            ...
            ?>
             ...
             ?>
               ...
               <b> <label for="txtntitulolabel" class="form-label">Titulo:</label></b>
                <input name="txttitulo" type="text" class="form-control mb-3" id="txttitulo" value = '<?php echo $pro_mostrar[1]  ?>' > 
              <b>  <label for="txtcategorialabel" class="form-label">Categoria: </label></b>
                <input name="txtcategoria" type="text" class="form-control mb-3" id="txtcategoria" value = '<?php echo $pro_mostrar[2]  ?>' >
                <b>  <label for="txtisbnlabel" class="form-label">ISBN: </label></b>
                <input name="txtisbn" type="text" class="form-control mb-3" id="txtisbn" value = '<?php echo $pro_mostrar[3]  ?>' >
                <b>  <label for="txtdatelabel" class="form-label">Idioma: </label></b>
                <input name="txtidioma" type="text" class="form-control mb-3" id="txtqtde" value = '<?php echo $pro_mostrar[4]  ?>' >
                <b>  <label for="txtqtdelabel" class="form-label">Quantidade de páginas: </label></b>
                <input name="txtqtde" type="text" class="form-control mb-3" id="txtqtde" value = '<?php echo $pro_mostrar[5]  ?>' >
...
<?php
        ...
        <fieldset class="border p-4">
            ...
            <button name="Voltar" class="btn btn-secondary"> <a style="text-decoration: none; color: white;" href="alterar_livro.php">Voltar</a></button>
            <button name="Listar" class="btn btn-secondary"> <a style="text-decoration: none; color: white;" href="listar_livro.php">Listar</a></button>
        </fieldset>
    </form>
    ...
    <?php
        ...
        if(isset($btnalterar)) {
            ...
            header("Location: alterar_livro.php");
