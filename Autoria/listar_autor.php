...
<div class="container mt-5 pt-5">
    <h1 class="text-center mb-4 mt-4">Autores Cadastrados</h1>
    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($pro_bd as $pro_mostrar) {
                                ?>
                                <tr>
                                    <td><?php echo $pro_mostrar['cod_autor']; ?></td>
                                    <td><?php echo $pro_mostrar['nome_autor']; ?></td>
                                    <td><?php echo $pro_mostrar['sobrenome']; ?></td>
                                    <td><?php echo $pro_mostrar['email']; ?></td>
                                    <td><?php echo $pro_mostrar['data_nascimento']; ?></td>
                                </tr>
                            <?php
                            }
                            ?>
