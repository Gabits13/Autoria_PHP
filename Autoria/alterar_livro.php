    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="autorDropdown">
                ...
                <li><a class="dropdown-item color-especial" href="#">Listar</a></li>
...
<div class="container mt-5 pt-5">
    <h1 class="text-center mb-4 mt-4">Alteração de Livro</h1>
    <form name="cliente" method="post" action="alterar_livro2.php" onsubmit="return validateForm()">
        <fieldset class="border p-4 mt-2">
            <legend class="w-auto"><b>Informe o Código do Livro desejado:</b></legend>
            <div class="mb-3">
                <input name="txtcod" type="text" class="form-control" id="txtcod" placeholder="Código do Livro">
            </div>
        </fieldset>
        <br>
